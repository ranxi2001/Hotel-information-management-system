...
"border-radius:5px")
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(30, 50, 521, 111))
        self.groupBox_3.setObjectName("groupBox_3")
        self.path1 = QtWidgets.QLineEdit(self.groupBox_3)
        self.path1.setGeometry(QtCore.QRect(20, 45, 351, 31))
        self.path1.setObjectName("path1")
        self.scan = QtWidgets.QPushButton(self.groupBox_3)
        self.scan.setGeometry(QtCore.QRect(380, 45, 51, 31))
        self.scan.setObjectName("scan")
        self.tosql1 = QtWidgets.QPushButton(self.groupBox_3)
        self.tosql1.setGeometry(QtCore.QRect(440, 45, 61, 31))
        self.tosql1.setObjectName("tosql1")
        self.groupBox_4 = QtWidgets.QGroupBox(self.page)
        self.groupBox_4.setGeometry(QtCore.QRect(30, 185, 521, 131))
        self.groupBox_4.setObjectName("groupBox_4")
        self.name1 = QtWidgets.QComboBox(self.groupBox_4)
        self.name1.setGeometry(QtCore.QRect(20, 35, 161, 31))
        self.name1.setObjectName("name1")
        self.name1.addItem("")
        self.name1.addItems(["booking_client", "booking_team", "checkin_client", "checkin_team", "client", "hotelorder", "room", "staff", "team"])
        self.path2 = QtWidgets.QLineEdit(self.groupBox_4)
        self.path2.setGeometry(QtCore.QRect(20, 80, 351, 31))
        self.path2.setObjectName("path2")
        self.scan_2 = QtWidgets.QPushButton(self.groupBox_4)
        self.scan_2.setGeometry(QtCore.QRect(380, 80, 51, 31))
        self.scan_2.setObjectName("scan_2")
        self.tosql2 = QtWidgets.QPushButton(self.groupBox_4)
        self.tosql2.setGeometry(QtCore.QRect(440, 80, 61, 31))
        self.tosql2.setObjectName("tosql2")
        self.groupBox_5 = QtWidgets.QGroupBox(self.page)
        self.groupBox_5.setGeometry(QtCore.QRect(30, 340, 521, 151))
        self.groupBox_5.setObjectName("groupBox_5")
        self.name2 = QtWidgets.QComboBox(self.groupBox_5)
        self.name2.setGeometry(QtCore.QRect(20, 35, 161, 31))
        self.name2.setObjectName("name2")
        self.name2.addItem("")
        self.name2.addItems(["booking_client", "booking_team", "checkin_client", "checkin_team", "client", "hotelorder", "room", "staff", "team"])
        self.path3 = QtWidgets.QLineEdit(self.groupBox_5)
        self.path3.setGeometry(QtCore.QRect(20, 85, 351, 31))
        self.path3.setObjectName("path3")
        self.scan_3 = QtWidgets.QPushButton(self.groupBox_5)
        self.scan_3.setGeometry(QtCore.QRect(380, 85, 51, 31))
        self.scan_3.setObjectName("scan_3")
        self.toexcel = QtWidgets.QPushButton(self.groupBox_5)
        self.toexcel.setGeometry(QtCore.QRect(440, 85, 61, 31))
        self.toexcel.setObjectName("toexcel")
        self.ask = QtWidgets.QPushButton(self.groupBox_5)
        self.ask.setGeometry(QtCore.QRect(380, 35, 121, 31))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "导出整个数据库为 SQL"))
        self.path1.setPlaceholderText(_translate("MainWindow", "请选择导出目录"))
        self.scan.setText(_translate("MainWindow", "浏览"))
        self.tosql1.setText(_translate("MainWindow", "导出"))
        self.groupBox_4.setTitle(_translate("MainWindow", "导出单个数据表为 SQL"))
        self.name1.setItemText(0, _translate("MainWindow", "请选择..."))
        self.path2.setPlaceholderText(_translate("MainWindow", "请选择导出目录"))
        self.scan_2.setText(_translate("MainWindow", "浏览"))
        self.tosql2.setText(_translate("MainWindow", "导出"))
        self.groupBox_5.setTitle(_translate("MainWindow", "导出单个数据表为 Excel"))
        self.name2.setItemText(0, _translate("MainWindow", "请选择..."))
        self.path3.setPlaceholderText(_translate("MainWindow", "请选择导出目录"))
        self.scan_3.setText(_translate("MainWindow", "浏览"))
        self.toexcel.setText(_translate("MainWindow", "导出"))
        self.ask.setText(_translate("MainWindow", "查看表说明"))
